		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices",
									"targetURL": "#lualbalsapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lualbalsapui5-display": {
								"semanticObject": "lualbalsapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lualbal.SAPUI5",
									"url": sap.ui.require.toUrl("lualbal/SAPUI5")
								}
							}
						}
					}
